...
#include "modules/SOS/SOSModule.h"
#endif
...
int32_t ButtonThread::runOnce()
{
    ...
    if (btnEvent != BUTTON_EVENT_NONE) {
        ...
        case BUTTON_EVENT_MULTI_PRESSED: { // not wired in when screen is present
            ...
            case 3:
#ifdef USE_SOS_MODULE
                // SOS ha priorità assoluta sul triple-click
                if (sosModule && millis() > 30000) {
                    sosModule->triggerSOS();
                    break; // Non propagare l'evento standard
                }
#endif
